...
General notes
#>
function Test-UserWindowsMediaPlayerPreventCodecDownload {
    [CmdletBinding()]
    param (
    ...
    begin {
        $EntryName = "Prevent Codec Download"
        $Result = [CISBenchmark]::new()
        $Result.Number = '19.7.42.2.1'
        $Result.Level = "L2"
        ...
        $Result.Title = "Ensure 'Prevent Codec Download' is set to 'Enabled'"
