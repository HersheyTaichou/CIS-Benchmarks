<#
.SYNOPSIS
19.6.6 Personalization

.DESCRIPTION
This command will test all the settings defined in section 19.6.6 of the CIS Microsoft Windows Server 2022 Benchmark v2.0.0.
...
General notes
#>
function Test-UserSystemInternetCommunicationManagement {
    [CmdletBinding()]
    param (
    ...
    process {
        if ($Level -eq 2) {
            Test-UserInternetCommunicationManagementNoImplicitFeedback @Parameters
        }
    }
}
