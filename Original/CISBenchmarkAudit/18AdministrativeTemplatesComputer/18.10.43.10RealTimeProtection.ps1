...
General notes
#>
function Test-RealTimeProtectionDisableIOAVProtection {
    [CmdletBinding()]
    param (
...
General notes
#>
function Test-RealTimeProtectionDisableRealtimeMonitoring {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-RealTimeProtectionDisableBehaviorMonitoring {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-RealTimeProtectionDisableScriptScanning {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()]$ProductType = (Get-ProductType),
