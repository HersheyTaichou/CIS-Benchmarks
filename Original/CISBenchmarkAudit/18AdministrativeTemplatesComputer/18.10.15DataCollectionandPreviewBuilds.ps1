...
General notes
#>
function Test-DataCollectionandPreviewBuildsAllowTelemetry {
    [CmdletBinding()]
    param (
    ...
    process {
        ...
        if (($Result.Setting -eq "Diagnostic data off (not recommended)" -or $Result.Setting -eq "Send required diagnostic data") -and $Result.Entry.State -eq "Enabled") {
...
General notes
#>
function Test-DataCollectionandPreviewBuildsDisableEnterpriseAuthProxy {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
    ...
    process {
        ...
        # NotConfigured maps to "Disable Authenticated Proxy usage"
        if ($Result.Setting -eq "NotConfigured" -and $Result.Entry.State -eq "Enabled") {
            $Result.SetCorrectly = $true
        } else {
            $Result.SetCorrectly = $false
        }
...
General notes
#>
function Test-DataCollectionandPreviewBuildsDisableOneSettingsDownloads {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DataCollectionandPreviewBuildsDoNotShowFeedbackNotifications {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DataCollectionandPreviewBuildsEnableOneSettingsAuditing {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DataCollectionandPreviewBuildsLimitDiagnosticLogCollection {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DataCollectionandPreviewBuildsLimitDumpCollection {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DataCollectionandPreviewBuildsAllowBuildPreview {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
