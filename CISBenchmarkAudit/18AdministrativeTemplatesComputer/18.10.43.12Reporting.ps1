...
General notes
#>
function Test-ReportingDisableGenericRePorts {
    [CmdletBinding()]
    param (
    ...
    begin {
        $EntryName = "Configure Watson events"
        $Result = [CISBenchmark]::new()
        $Result.Number = '18.10.43.12.1'
        $Result.Level = "L2"
        if ($ProductType -eq 1) {
        ...
        $Result.Title = "Ensure 'Configure Watson events' is set to 'Disabled'"
