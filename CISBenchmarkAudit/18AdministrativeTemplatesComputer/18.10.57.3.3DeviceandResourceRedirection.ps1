...
General notes
#>
function Test-DeviceandResourceRedirectionEnableUiaRedirection {
    [CmdletBinding()]
    param (
...
General notes
#>
function Test-DeviceandResourceRedirectionfDisableCcm {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DeviceandResourceRedirectionfDisableCdm {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DeviceandResourceRedirectionfDisableLocationRedir {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DeviceandResourceRedirectionfDisableLPT {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DeviceandResourceRedirectionfDisablePNPRedir {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-DeviceandResourceRedirectionfDisableWebAuthn {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
