...
.DESCRIPTION
This command will test all the settings defined in section 19.1.3 of the CIS Microsoft Windows Server 2022 Benchmark v2.0.0.
...
General notes
#>
function Test-UserControlPanelPersonalization {
    [CmdletBinding()]
    param (
    ...
    process {
        Test-UserPersonalizationScreenSaveActive @Parameters
        Test-UserPersonalizationScreenSaverIsSecure @Parameters
        Test-UserPersonalizationScreenSaveTimeOut @Parameters
    }
}
