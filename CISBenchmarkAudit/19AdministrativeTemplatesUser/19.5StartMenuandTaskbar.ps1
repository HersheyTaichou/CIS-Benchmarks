...
.DESCRIPTION
This command will test all the settings defined in section 19.5.1 of the CIS Microsoft Windows Server 2022 Benchmark v2.0.0.
...
General notes
#>
function Test-UserStartMenuAndTaskbarNotifications {
    [CmdletBinding()]
    param (
    ...
    process {
        Test-UserNotificationsNoToastApplicationNotificationOnLockScreen @Parameters
    }
}
