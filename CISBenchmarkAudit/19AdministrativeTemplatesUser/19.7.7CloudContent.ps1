...
General notes
#>
function Test-UserCloudContentConfigureWindowsSpotlight {
    [CmdletBinding()]
    param (
...
General notes
#>
function Test-UserCloudContentDisableThirdPartySuggestions {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-UserCloudContentDisableTailoredExperiencesWithDiagnosticData {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-UserCloudContentDisableWindowsSpotlightFeatures {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
...
General notes
#>
function Test-UserCloudContentDisableSpotlightCollectionOnDesktop {
    [CmdletBinding()]
    param (
        # Get the product type (1, 2 or 3)
        [Parameter()][ValidateSet(1,2,3)][int]$ProductType = (Get-ProductType),
